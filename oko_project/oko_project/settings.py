"""
Django settings for oko_project project.
...
SECRET_KEY = 'django-insecure-e5z(s4kils*d!v1*&&rwlg)ge$_!)w__8)h@ws&-@i85i3%6#3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['reklamaoko.ru','*']
