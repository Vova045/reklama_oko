...
function applyFolderFilterForAllFields() {
    const folderSelectTechnology = document.querySelectorAll('[id^="id_goodscomposition_set-"][id$="-folder_technology"]');
    ...
    folderSelectTechnology.forEach((folderSelectTechnology_in, index) => {
        const technologyField = document.querySelector(`#id_goodscomposition_set-${index}-technology`);
        const techOperationField = document.querySelector(`#id_goodscomposition_set-${index}-techoperation`);
        const folderField = document.querySelector(`#id_goodscomposition_set-${index}-folder_technology`);
        const nomenclatureField = document.querySelector(`#id_goodscomposition_set-${index}-nomenclature`);
...
function copyFolderValue() {
    ...
    const folderFields = document.querySelectorAll('[id^="id_goodscomposition_set-"][id$="-folder_technology"]');
    ...
    if (folderFields.length > 1) {
        ...
        if (visibleFolderFields.length > 1) {
            ...
            const lastFields = {
                folder: document.querySelector(`#id_goodscomposition_set-${lastIndex}-folder_technology`),
                technology: document.querySelector(`#id_goodscomposition_set-${lastIndex}-technology`),
                techOperation: document.querySelector(`#id_goodscomposition_set-${lastIndex}-techoperation`),
                nomenclature: document.querySelector(`#id_goodscomposition_set-${lastIndex}-nomenclature`),
            };
            
            const newFields = {
                folder: document.querySelector(`#id_goodscomposition_set-${newIndex}-folder_technology`),
                technology: document.querySelector(`#id_goodscomposition_set-${newIndex}-technology`),
                techOperation: document.querySelector(`#id_goodscomposition_set-${newIndex}-techoperation`),
                nomenclature: document.querySelector(`#id_goodscomposition_set-${newIndex}-nomenclature`),
            };
